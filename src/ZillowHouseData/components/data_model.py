...
class DataModeling:
    ...
    def preprocess_data(self, df):
        try:
            ...
            indicator_encoding = {'Z1BR': 0, 'Z2BR': 1, 'Z3BR': 2, 'Z4BR': 3, 'Z5BR': 4, 'ZABT': 5, 'ZALL': 6, 'ZATT': 7, 'ZCON': 8, 'ZSFH': 9}
    ...
    def train_model(self, model, X_train, y_train, epochs=3, batch_size=32, validation_split=0.1):
        try:
            # Train the model
